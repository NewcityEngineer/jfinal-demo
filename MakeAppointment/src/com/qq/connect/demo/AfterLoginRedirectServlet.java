...
//                做一些数据统计工作
               ...
               // out.println("<br/>");
                if (userInfoBean.getRet() == 0) {
                	...
                	imgurl=userInfoBean.getAvatar().getAvatarURL30();
                	
                	response.sendRedirect(style+"?userid="+userid+"&openid="+openid+"&nickname="+nickname+"&gender="+gender+"&imgurl="+imgurl+"&name="+name);
