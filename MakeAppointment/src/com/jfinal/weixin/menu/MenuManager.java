...
public class MenuManager  {
	public static void main(String[] args) { 
		...
		// 配置微信 API 相关常量
		ac.setAppId("wx107b4f536b4c47db");
		ac.setAppSecret("7fb9e28f46459b7336864575ca96fc7f");
//		ac.setAppId("wx6080c31355b4073e");
//		ac.setAppSecret("5224a224c6912d26c0b6ade3247e8440");
		//		ac.setAppId(Prop.use("appId"));
	...
	private static Menu getTestMenu() {  
		String appId="wx107b4f536b4c47db";
		String oauth_redirect_uri="wx.xinewang.com";
//		String appId="wx6080c31355b4073e";
//		String oauth_redirect_uri="tianlixin.cyansoft.cn";
		...
		mainBtn3.setSub_button(new Button[] { btn31, btn32, btn34, btn35, btn33 });// btn34,
